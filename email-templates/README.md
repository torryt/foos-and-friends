...
This repository contains customized email templates for Supabase authentication emails, designed to be used for both sport tracking apps: foosball and chess. The templates include confirmation emails, magic link emails, and password recovery emails.
...
- **Branding**: Uses generic "Game Tracker" name that applies to both apps (foosball, chess)