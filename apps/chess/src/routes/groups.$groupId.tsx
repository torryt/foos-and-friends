...
// This app only serves chess groups; a foosball group's id 404s here
const SPORT_TYPE = 'chess'
          ...
          <div className="px-4 py-3 flex justify-between items-center">
            <div className="min-w-0">
              <h1 className="text-lg md:text-2xl font-bold text-sport-gradient flex items-center gap-2 truncate">
                <Crown className="text-[var(--th-sport-primary)] shrink-0" size={20} />
                {group.name}
              </h1>
              <p className="text-xs md:text-sm text-secondary">Read-only view · Chess & Friends</p>
            </div>
