  ...
  <div className="bg-white/60 backdrop-blur-sm rounded-xl p-8 border border-white/50 mb-8">
    ...
    <div className="grid md:grid-cols-2 gap-4">
      <button
        ...
        className="flex items-center justify-center gap-3 p-4 bg-gradient-to-r from-[#832161] to-[#DA4167] text-white rounded-lg hover:from-[#3D2645] hover:to-[#832161] transition-all font-medium"
      >
        <Plus size={20} />
