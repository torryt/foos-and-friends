        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
            ...
            <button
              ...
              className="w-full flex items-center justify-between gap-2 p-3 min-h-12 rounded-lg border border-blue-300 bg-white hover:bg-gray-50 text-left transition-colors"
            >
              {getPlayer(player1Id) ? (
                ...
                <span className="truncate text-gray-400">Select Player</span>
              )}
          ...
          <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
            ...
            <button
              ...
              className="w-full flex items-center justify-between gap-2 p-3 min-h-12 rounded-lg border border-purple-300 bg-white hover:bg-gray-50 text-left transition-colors"
            >
              {getPlayer(player2Id) ? (
                <span className="truncate text-gray-900">
