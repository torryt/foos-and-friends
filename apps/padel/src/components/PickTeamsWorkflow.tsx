...
export const PickTeamsWorkflow = ({
  ...
  return (
    <ModalOrBottomDrawer onClose={onClose} className="sm:max-w-md">
      <div className="bg-white w-full shadow-2xl border border-gray-100 flex flex-col max-h-[90vh]">
        ...
        {/* Sticky Footer */}
        <div
          className="flex-shrink-0 px-6 pt-4 border-t border-gray-100 bg-white"
